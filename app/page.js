      ...
      <section id="hero" className="pt-28 pb-20 px-6 text-center" style={{ background: "linear-gradient(180deg, #f5f3ff 0%, #ffffff 100%)" }}>
        <div style={{ maxWidth: 720, margin: "0 auto" }}>
          ...
          <h1 className="leading-tight mb-6 scroll-animate" style={{ transitionDelay: "0.05s" }}>
            ...
            <div className="hero-animated-line" style={{ minHeight: "180px", paddingBottom: "16px", display: "flex", alignItems: "center", justifyContent: "center", width: "100%", maxWidth: "100%", overflow: "visible", padding: "0 20px 16px", marginBottom: "32px" }}>
              <span
                key={animatedWord}
                style={{
                  fontFamily: "var(--font-playfair)",
